var turnWebcamOn, isWebcamOn, turnWebcamOff,  flip ;
...
(function() {
  ...
  function handlePositiveIdentification(classification) {
    ...
    let type = document.getElementById("webcam-label-container");
    type.innerHTML = "<h1>" + classification + "</h1>";

    if (classification == "Put on some gold!"){
      type.style.color = "red"
    }
    if(classification == "Nice Pride!"){
